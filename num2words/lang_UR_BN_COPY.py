...
# Email: usman.dcse [at] gmail.com
# Copyright (c) 2024, Muhammad Usman.  All Rights Reserved.

# This library is build for Urdu format Number to Word conversion.
...
RANKING = ['', 'پہلا', 'دوسرا', 'تیسرا', 'چوتھا', 'پانچویں', 'چھٹا',
           'ساتویں', 'آٹھویں', 'نویں', 'دسویں']  # pragma: no cover

AKOK = ['', 'ایک', 'دو', 'تین', 'چار', 'پانچ', 'چھ',
        'سات', 'آٹھ', 'نو']  # pragma: no cover
